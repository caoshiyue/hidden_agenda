...
import tensorboard
# tensorboard --logdir=results/sb3/hidden/A2C_11
...
def main():
  ...
  model.learn(total_timesteps=save_interval, callback=eval_callback)
  ...
  for i in range(total_timesteps//save_interval-1):
    ...
    model.save(logdir + f"/model{save_interval*(i+2) }")
